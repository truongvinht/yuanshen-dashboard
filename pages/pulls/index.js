...
const pulls = ({ pulls, actions = {} }) => {
  ...
  return (
    <div style={{height: '90%' ,width: '100%', position: 'fixed'}}>
      <Head>
      ...
      <div className="ag-theme-alpine" style={{ height: '80%',width: '100%' }}>
        ...
        >
          ...
          <AgGridColumn headerName="Ziehung" field="object_ref" cellStyle={dynamicCellStyle} resizable="true"></AgGridColumn>
          <AgGridColumn headerName="Zeit" field="eventTime" valueFormatter={valueFormatter} cellStyle={dynamicCellStyle}></AgGridColumn>
