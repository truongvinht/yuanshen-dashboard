...
export async function postData(apiPath, dataModel, completionBlock = undefined) {
...
export async function putData(objId, apiPath, dataModel, completionBlock = undefined) {
    const contentType = 'application/json'
    const REQUEST = 'PUT'
...
export async function deleteData(objId, apiPath, dataModel, completionBlock = undefined) {
...
export default { postData, putData, deleteData }